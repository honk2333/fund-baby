...
import { fetchFundData, fetchIntradayData, fetchLatestRelease, fetchShanghaiIndexDate, fetchSmartFundNetValue, searchFunds } from './api/fund';
  ...
  return (
    <div className="container content">
      ...
      <div className="footer">
        ...
        <div style={{ margin: 0 }}>
          发现 Bug 或需求建议可前往 <a href="https://github.com/zhengshengning/fund-baby/issues" target="_blank" style={{ color: 'var(--primary)', textDecoration: 'underline', fontWeight: 600 }}>Github Issues</a> 反馈
        </div>
        <button
